                                                                ...
                                                                <link rel="stylesheet" href="css/transitions.css">
                                                                    <link rel="stylesheet" href="css/responsive.css">
                                                                                ...
                                                                                <div class="row justify-content-md-center">
                                                                                    <div class="col-xs-12 col-sm-12 col-md-8 push-md-2 col-lg-6 push-lg-3">
                                                                                        <div class="wt-innerbannercontent">
                                                                                            <div class="wt-title"><h2>Duyuru Güncelle</h2></div>
                                                                                            <ol class="wt-breadcrumb">
                                                                                                <li><a href="index.jsp">Ana Sayfa</a></li>
                                                                                                <li class="wt-active">Duyuru Güncelle</li>
                                                                                            </ol>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                                        ...
                                                                                                        <div class="wt-securitysettings wt-tabsinfo">
                                                                                                            ...
                                                                                                            <form class="wt-formtheme wt-userform" action="" method="post">
                                                                                                                ...
                                                                                                                <fieldset>
                                                                                                                    ...
                                                                                                                    <div class="form-group form-disabeld">
                                                                                                                        <div class="form-group">
                                                                                                                            <textarea name="duyuru" class="form-control" placeholder="Duyuru giriniz"></textarea>
                                                                                                                        </div>
                                                                                                                    </div>
                                                                                                                ...
                                                                                                                <div class="wt-updatall">
                                                                                                                    ...
                                                                                                                    <input type="submit" class="wt-btn" href="javascript:void(0);" value="Güncelle">
                                                                                                                </div>
                                                                                                            </form>
                                                                                                        </div>
                                                                                                    </div>
                                                                        ...
                                                                        <%
                                                                            ...
                                                                            boolean guncellediMi = duyurular.duyuruGuncelle(duyuruID, duyuruBaslik, duyuruMetin);
                                                                            if (guncellediMi == true) {
                                                                                //out.println("<script>alert('Güncellendi')</script>");
